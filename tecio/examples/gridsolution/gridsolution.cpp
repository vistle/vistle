...
int main()
{
    ...
    INTEGER4 NumPts             = 20;  /* the number of unique
                                        ...
                                        */
    INTEGER4 NumElems           = 1;
    INTEGER8 NumFaces           = 12;  /* the number of unique
                                        * faces in the zone.
                                        */
     ...
     * is a pentagon.
     */
    INTEGER8 TotalNumFaceNodes  = 5 * NumFaces;
    ...
    I = TECPOLYZNE142((char*)"Dodecahedron", /* Name of the zone. */
                      &ZoneType,
                      &NumPts,
                      &NumElems,
                      &NumFaces,
    ...
    for(int J = 0; J < 5; J++)
    {
        std::ostringstream solutionFileName;
        solutionFileName << "gridsolution-solution" << J << ".plt";
        ...
        /* TECPOLYZNE Parameters are mostly unchanged from creation of the grid file. */
        TotalNumFaceNodes = 0;
        SolutionTime = J;

        std::ostringstream zoneName;
        zoneName << "Dodecahedron Time=" << SolutionTime;
        I = TECPOLYZNE142(zoneName.str().c_str(),
                      &ZoneType,
                      &NumPts,
                      &NumElems,
                      &NumFaces,
