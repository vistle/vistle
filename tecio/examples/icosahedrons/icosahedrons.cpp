...
int main(int argc, char** argv)
{
    ...
    INTEGER8 numFaces = 20;    // Number of faces in the icosahedron.
    double   solTime = 0.0;
    ...
    INTEGER4 nFConns = 0;
    INTEGER4 fNMode = 0;
    INTEGER8 numFaceNodes = 3 * numFaces; // All faces are triangular, so 3 nodes per face
    INTEGER4 numBFaces = 0;
    INTEGER4 numBConnections = 0;
    INTEGER4 shrConn = 0;

    i = TECPOLYZNE142((char*)"Icosahedral Zone",
        &zoneType,
        &numNodes,
        &numElems,
        &numFaces,
