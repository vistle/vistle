...
<svg width="3432.0" height="210" >
<style>.text { font: normal 24.0px sans-serif;}tspan{ font: italic 24.0px sans-serif;}.moduleName{ font: italic 30px sans-serif;}</style>
<rect x="0" y="60" width="343.2" height="90" rx="5" ry="5" style="fill:#64c8c8ff;" />
...
<text x="6.0" y="115.5" class="moduleName" >EnableTransparency</text></svg>
