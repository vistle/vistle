...
<svg width="3954.0" height="210" >
<style>.text { font: normal 24.0px sans-serif;}tspan{ font: italic 24.0px sans-serif;}.moduleName{ font: italic 30px sans-serif;}</style>
<rect x="0" y="60" width="395.4" height="90" rx="5" ry="5" style="fill:#64c8c8ff;" />
...
<text x="57.0" y="33.0" class="text" >input grid<tspan> (grid_in)</tspan></text>
...
<text x="57.0" y="183.0" class="text" >output grid<tspan> (grid_out)</tspan></text>
<text x="6.0" y="115.5" class="moduleName" >CreateVertexOwnerList</text></svg>
