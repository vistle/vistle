...
macro(generate_snapshots targetname network_file)
    if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/${network_file}.vwp
        ...
        add_custom_target(${targetname}_${network_file}_result DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/${network_file}_result.png
                                                                       ${CMAKE_CURRENT_BINARY_DIR}/${network_file}_workflow.png)
