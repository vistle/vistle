...
static VisIt_CommandMetaData *GetObject(visit_handle h, const char *fname)
{
    char tmp[150];
...
int simv2_CommandMetaData_setName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_CommandMetaData_getName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_CommandMetaData_setEnabled(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_CommandMetaData_getEnabled(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_CommandMetaData_check(visit_handle h)
{
