...
V_LIBSIMXPORT int simv2_CurvilinearMesh_setCoordsXY(visit_handle obj, int dims[2], visit_handle x, visit_handle y);
V_LIBSIMXPORT int simv2_CurvilinearMesh_setCoordsXYZ(visit_handle obj, int dims[3], visit_handle x, visit_handle y,
                                                     visit_handle z);
V_LIBSIMXPORT int simv2_CurvilinearMesh_setCoords2(visit_handle obj, int dims[2], visit_handle c);
V_LIBSIMXPORT int simv2_CurvilinearMesh_setCoords3(visit_handle obj, int dims[3], visit_handle c);
...
V_LIBSIMXPORT int simv2_CurvilinearMesh_getCoords(visit_handle h, int *ndims, int dims[3], int *coordMode,
