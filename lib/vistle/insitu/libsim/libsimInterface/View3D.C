...
static VisIt_View3D *GetObject(visit_handle h, const char *fname)
{
    char tmp[150];
    ...
    if (obj != NULL) {
        if (obj->objectType() != VISIT_VIEW3D) {
            snprintf(tmp, 150,
                     ...
                     "a View3D object. (type=%d)",
                     fname, obj->objectType());
            VisItError(tmp);
            obj = NULL;
        }
    } else {
...
int simv2_View3D_setViewNormal(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getViewNormal(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setFocus(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getFocus(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setViewUp(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getViewUp(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setViewAngle(visit_handle h, double val)
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getViewAngle(visit_handle h, double *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setParallelScale(visit_handle h, double val)
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getParallelScale(visit_handle h, double *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setNearPlane(visit_handle h, double val)
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getNearPlane(visit_handle h, double *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setFarPlane(visit_handle h, double val)
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getFarPlane(visit_handle h, double *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setImagePan(visit_handle h, double val[2])
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getImagePan(visit_handle h, double val[2])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setImageZoom(visit_handle h, double val)
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getImageZoom(visit_handle h, double *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setPerspective(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getPerspective(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setEyeAngle(visit_handle h, double val)
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getEyeAngle(visit_handle h, double *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setCenterOfRotationSet(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getCenterOfRotationSet(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setCenterOfRotation(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getCenterOfRotation(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setAxis3DScaleFlag(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getAxis3DScaleFlag(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setAxis3DScales(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getAxis3DScales(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setShear(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getShear(visit_handle h, double val[3])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_setWindowValid(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_View3D_getWindowValid(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View3D_copy(visit_handle dest, visit_handle src)
{
    int retval = VISIT_ERROR;
