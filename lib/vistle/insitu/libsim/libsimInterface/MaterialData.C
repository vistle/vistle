...
VisIt_MaterialData::VisIt_MaterialData(): VisIt_ObjectBase(VISIT_MATERIAL_DATA), matnos(), matNames()
{
    appendMode = false;
    ncells = 0;
...
void VisIt_MaterialData::FreeMaterials()
{
...
void VisIt_MaterialData::FreeMixedMaterials()
{
...
static VisIt_MaterialData *GetObject(visit_handle h)
{
...
int simv2_MaterialData_addMaterial(visit_handle h, const char *matName, int *matno)
{
    VisIt_MaterialData *obj = GetObject(h);
    int retval = VISIT_ERROR;
    if (matName == NULL) {
...
int simv2_MaterialData_appendCells(visit_handle h, int ncells)
{
    VisIt_MaterialData *obj = GetObject(h);
    int retval = VISIT_ERROR;
    if (obj != NULL) {
        ...
        simv2_VariableData_setData(obj->matlist, VISIT_OWNER_VISIT, VISIT_DATATYPE_INT, 1, ncells, obj->matlistA);
...
int simv2_MaterialData_addCleanCell(visit_handle h, int cell, int matno)
{
    VisIt_MaterialData *obj = GetObject(h);
    int retval = VISIT_ERROR;
    if (obj != NULL) {
...
int simv2_MaterialData_addMixedCell(visit_handle h, int cell, const int *matnos, const float *mixvf, int nmats)
{
    VisIt_MaterialData *obj = GetObject(h);
    int retval = VISIT_ERROR;
    if (obj != NULL) {
...
int simv2_MaterialData_setMaterials(visit_handle h, visit_handle matlist)
{
    int owner, dataType, nComps, nTuples;
    void *data = NULL;
    if (simv2_VariableData_getData(matlist, owner, dataType, nComps, nTuples, data) == VISIT_ERROR) {
...
int simv2_MaterialData_setMixedMaterials(visit_handle h, visit_handle mix_mat, visit_handle mix_zone,
                                         visit_handle mix_next, visit_handle mix_vf)
{
    ...
    for (int i = 0; i < 4; ++i) {
        ...
        if (i == 3 && dataType[i] != VISIT_DATATYPE_DOUBLE && dataType[i] != VISIT_DATATYPE_FLOAT) {
 ...
 ******************************************************************************/
int simv2_MaterialData_getNumMaterials(visit_handle h, int &nmat)
{
    VisIt_MaterialData *obj = GetObject(h);
    int retval = VISIT_ERROR;
    if (obj != NULL) {
...
int simv2_MaterialData_getMaterial(visit_handle h, int i, int &matno, char *matname, int maxlen)
{
    VisIt_MaterialData *obj = GetObject(h);
    int retval = VISIT_ERROR;
...
int simv2_MaterialData_getMaterials(visit_handle h, visit_handle &matlist)
{
    VisIt_MaterialData *obj = GetObject(h);
    int retval = VISIT_ERROR;
    if (obj != NULL) {
...
int simv2_MaterialData_getMixedMaterials(visit_handle h, visit_handle &mix_mat, visit_handle &mix_zone,
                                         visit_handle &mix_next, visit_handle &mix_vf)
{
    VisIt_MaterialData *obj = GetObject(h);
    int retval = VISIT_ERROR;
    if (obj != NULL) {
        if (obj->appendMode) {
            ...
            if (obj->mix_matA.size() > 0) {
                ...
                simv2_VariableData_setData(obj->mix_mat, VISIT_OWNER_SIM, VISIT_DATATYPE_INT, 1,
                                           (int)obj->mix_matA.size(), (void *)&obj->mix_matA[0]);

                simv2_VariableData_alloc(&obj->mix_zone);
                simv2_VariableData_setData(obj->mix_zone, VISIT_OWNER_SIM, VISIT_DATATYPE_INT, 1,
                                           (int)obj->mix_zoneA.size(), (void *)&obj->mix_zoneA[0]);

                simv2_VariableData_alloc(&obj->mix_next);
                simv2_VariableData_setData(obj->mix_next, VISIT_OWNER_SIM, VISIT_DATATYPE_INT, 1,
                                           (int)obj->mix_nextA.size(), (void *)&obj->mix_nextA[0]);

                simv2_VariableData_alloc(&obj->mix_vf);
                simv2_VariableData_setData(obj->mix_vf, VISIT_OWNER_SIM, VISIT_DATATYPE_FLOAT, 1,
                                           (int)obj->mix_vfA.size(), (void *)&obj->mix_vfA[0]);
            }
        }
...
int simv2_MaterialData_check(visit_handle h)
{
    VisIt_MaterialData *obj = GetObject(h);
    int retval = VISIT_ERROR;
    if (obj != NULL) {
