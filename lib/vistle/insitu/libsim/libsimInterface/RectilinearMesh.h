...
V_LIBSIMXPORT int simv2_RectilinearMesh_setCoordsXYZ(visit_handle obj, visit_handle x, visit_handle y, visit_handle z);
V_LIBSIMXPORT int simv2_RectilinearMesh_setRealIndices(visit_handle obj, int min[3], int max[3]);
V_LIBSIMXPORT int simv2_RectilinearMesh_setBaseIndex(visit_handle obj, int base_index[3]);
...
V_LIBSIMXPORT int simv2_RectilinearMesh_getGhostNodes(visit_handle h, visit_handle *gn);
...
V_LIBSIMXPORT int simv2_RectilinearMesh_check(visit_handle h);
