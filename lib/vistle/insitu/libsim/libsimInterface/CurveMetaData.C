...
static VisIt_CurveMetaData *GetObject(visit_handle h, const char *fname)
{
    char tmp[100];
...
int simv2_CurveMetaData_setName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_CurveMetaData_getName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_CurveMetaData_setXUnits(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_CurveMetaData_getXUnits(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_CurveMetaData_setYUnits(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_CurveMetaData_getYUnits(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_CurveMetaData_setXLabel(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_CurveMetaData_getXLabel(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_CurveMetaData_setYLabel(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_CurveMetaData_getYLabel(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_CurveMetaData_check(visit_handle h)
{
