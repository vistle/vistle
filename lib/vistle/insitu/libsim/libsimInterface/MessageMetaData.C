...
static VisIt_MessageMetaData *GetObject(visit_handle h, const char *fname)
{
    char tmp[150];
...
int simv2_MessageMetaData_setName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MessageMetaData_getName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MessageMetaData_check(visit_handle h)
{
