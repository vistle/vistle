...
static VisIt_View2D *GetObject(visit_handle h, const char *fname)
{
    char tmp[150];
...
int simv2_View2D_setWindowCoords(visit_handle h, double val[4])
{
    int retval = VISIT_ERROR;
...
int simv2_View2D_getWindowCoords(visit_handle h, double val[4])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View2D_setViewportCoords(visit_handle h, double val[4])
{
    int retval = VISIT_ERROR;
...
int simv2_View2D_getViewportCoords(visit_handle h, double val[4])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View2D_setFullFrameActivationMode(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_View2D_getFullFrameActivationMode(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View2D_setFullFrameAutoThreshold(visit_handle h, double val)
{
    int retval = VISIT_ERROR;
...
int simv2_View2D_getFullFrameAutoThreshold(visit_handle h, double *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View2D_setXScale(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_View2D_getXScale(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View2D_setYScale(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_View2D_getYScale(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View2D_setWindowValid(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_View2D_getWindowValid(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_View2D_copy(visit_handle dest, visit_handle src)
{
    int retval = VISIT_ERROR;
