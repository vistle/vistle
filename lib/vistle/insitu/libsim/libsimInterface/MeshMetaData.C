...
static VisIt_MeshMetaData *GetObject(visit_handle h, const char *fname)
{
    char tmp[100];
...
int simv2_MeshMetaData_setName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_setMeshType(visit_handle h, int val)
{
    if (val != VISIT_MESHTYPE_UNKNOWN && val != VISIT_MESHTYPE_RECTILINEAR && val != VISIT_MESHTYPE_CURVILINEAR &&
        val != VISIT_MESHTYPE_UNSTRUCTURED && val != VISIT_MESHTYPE_POINT && val != VISIT_MESHTYPE_CSG &&
        val != VISIT_MESHTYPE_AMR) {
        VisItError("The value for meshType must be one of: VISIT_MESHTYPE_UNKNOWN, VISIT_MESHTYPE_RECTILINEAR, "
                   "VISIT_MESHTYPE_CURVILINEAR, VISIT_MESHTYPE_UNSTRUCTURED, VISIT_MESHTYPE_POINT, VISIT_MESHTYPE_CSG, "
                   "VISIT_MESHTYPE_AMR");
        return VISIT_ERROR;
    }
    int retval = VISIT_ERROR;
...
int simv2_MeshMetaData_getMeshType(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_setTopologicalDimension(visit_handle h, int val)
{
    if (val < 0 || val > 3) {
...
int simv2_MeshMetaData_getTopologicalDimension(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_setSpatialDimension(visit_handle h, int val)
{
    if (val < 0 || val > 3) {
...
int simv2_MeshMetaData_getSpatialDimension(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_setNumDomains(visit_handle h, int val)
{
    if (val < 1) {
...
int simv2_MeshMetaData_getNumDomains(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_setDomainTitle(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getDomainTitle(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_setDomainPieceName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getDomainPieceName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_addDomainName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getNumDomainName(visit_handle h, int *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getDomainName(visit_handle h, int i, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_setNumGroups(visit_handle h, int val)
{
    if (val < 0) {
...
int simv2_MeshMetaData_getNumGroups(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_setGroupTitle(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getGroupTitle(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_addGroupName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getNumGroupName(visit_handle h, int *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getGroupName(visit_handle h, int i, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_setGroupPieceName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getGroupPieceName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_addGroupId(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_MeshMetaData_getNumGroupId(visit_handle h, int *n)
{
    int retval = VISIT_ERROR;
...
int simv2_MeshMetaData_getGroupId(visit_handle h, int i, int *val)
{
    int retval = VISIT_ERROR;
...
int simv2_MeshMetaData_setXUnits(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getXUnits(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_setYUnits(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getYUnits(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_setZUnits(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getZUnits(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_setXLabel(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getXLabel(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_setYLabel(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getYLabel(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_setZLabel(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_getZLabel(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MeshMetaData_setCellOrigin(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_MeshMetaData_getCellOrigin(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_setNodeOrigin(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_MeshMetaData_getNodeOrigin(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_setHasSpatialExtents(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_MeshMetaData_getHasSpatialExtents(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_setSpatialExtents(visit_handle h, double val[6])
{
    int retval = VISIT_ERROR;
...
int simv2_MeshMetaData_getSpatialExtents(visit_handle h, double val[6])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_setHasLogicalBounds(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_MeshMetaData_getHasLogicalBounds(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_setLogicalBounds(visit_handle h, int val[3])
{
    int retval = VISIT_ERROR;
...
int simv2_MeshMetaData_getLogicalBounds(visit_handle h, int val[3])
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_MeshMetaData_check(visit_handle h)
{
