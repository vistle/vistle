...
constexpr int elementTypesVistle[numElementTypes] = {UnstructuredGrid::Type::POINT, UnstructuredGrid::Type::TRIANGLE, UnstructuredGrid::Type::QUAD, UnstructuredGrid::Type::TETRAHEDRON, UnstructuredGrid::Type::HEXAHEDRON, UnstructuredGrid::Type::PYRAMID, UnstructuredGrid::Type::PRISM};
