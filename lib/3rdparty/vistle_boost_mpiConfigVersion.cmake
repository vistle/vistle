...
if(PACKAGE_FIND_VERSION_RANGE)
    message(
        AUTHOR_WARNING
            "`find_package()` specify a version range but the version strategy " "(ExactVersion) of the module `${PACKAGE_FIND_NAME}` is incompatible "
...
if(PACKAGE_FIND_VERSION MATCHES "^([0-9]+)\\.([0-9]+)\\.([0-9]+)") # strip the tweak version
    ...
    set(REQUESTED_VERSION_NO_TWEAK "${REQUESTED_VERSION_MAJOR}.${REQUESTED_VERSION_MINOR}.${REQUESTED_VERSION_PATCH}")
else()
