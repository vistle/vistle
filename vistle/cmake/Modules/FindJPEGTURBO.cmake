...
FIND_LIBRARY(TURBOJPEG_LIBRARY_DYNAMIC turbojpeg
  HINTS ${JPEGTURBO_PREFIX}/lib ${JPEGTURBO_PREFIX}/lib64
  PATHS
  $ENV{JPEGTURBO_HOME}
  $ENV{EXTERNLIBS}/libjpeg-turbo64
...
if("${TURBOJPEG_LIBRARY_STATIC}" STREQUAL "${TURBOJPEG_LIBRARY_DYNAMIC}")
  set(TURBOJPEG_LIBRARY ${TURBOJPEG_LIBRARY_STATIC})
else()
  set(TURBOJPEG_LIBRARY ${TURBOJPEG_LIBRARY_DYNAMIC})
endif()
