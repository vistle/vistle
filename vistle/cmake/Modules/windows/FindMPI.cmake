...
FIND_LIBRARY(MPI_LIBRARY NAMES msmpi libmpi
  PATHS ${MPIDIRS}
  PATH_SUFFIXES amd64 lib lib64 
  DOC "MPI - Library"
)
...
FIND_LIBRARY(MPI_LIBRARY_DEBUG NAMES msmpi libmpid
  PATHS ${MPIDIRS}
  PATH_SUFFIXES amd64 lib lib64 
  DOC "MPI - Library"
)
...
IF(MSVC)
  ...
  IF(MPI_LIBRARY_DEBUG AND MPI_LIBRARY)
    ...
    #ELSE(MPI_PAL_LIBRARY)
	SET(MPI_LIBRARIES optimized ${MPI_LIBRARY} debug ${MPI_LIBRARY_DEBUG})
    SET(MPI_C_LIBRARIES optimized ${MPI_LIBRARY} debug ${MPI_LIBRARY_DEBUG})
	#ENDIF(MPI_PAL_LIBRARY)
