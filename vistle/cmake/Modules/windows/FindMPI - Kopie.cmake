...
if(WIN32)
  ...
  list(APPEND _MPI_PREFIX_PATH "$ENV{EXTERNLIBS}/OpenMPI/")
endif()
...
function (interrogate_mpi_compiler lang try_libs)
  ...
  if (interrogate AND ((NOT MPI_${lang}_INCLUDE_PATH) OR (NOT MPI_${lang}_LIBRARIES)))
	...
	if(WIN32)
	set(MPI_COMPILER_RETURN 1)
	endif(WIN32)
	
        #message(${ERROR_VARIABLE})
        #message(${RESULT_VARIABLE})
        #message(${MPI_COMPILER_RETURN})
        #message(${MPI_COMPILE_CMDLINE})
	#message(${MPI_${lang}_COMPILER})
