...
IF (WIN32)
  ...
  SET(TBB_LIBDIR $ENV{EXTERNLIBS}/tbb/lib/${TBB_ARCH}/${TBB_VCVER} ${TBB_ROOT}/lib/${TBB_ARCH}/${TBB_VCVER})
  SET(TBB_BINDIR $ENV{EXTERNLIBS}/tbb/bin/${TBB_ARCH}/${TBB_VCVER})

  FIND_PATH(TBB_INCLUDE_DIR tbb/task_scheduler_init.h PATHS $ENV{EXTERNLIBS}/tbb ${TBB_ROOT}/include NO_DEFAULT_PATH)
