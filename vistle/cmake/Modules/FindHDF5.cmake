...
FIND_LIBRARY(HDF5_C++_LIBRARY NAMES hdf5_c++ hdf5_cpp
   PATHS
   $ENV{EXTERNLIBS}/hdf5
) 
...
IF(MSVC)
  ...
  FIND_PACKAGE_HANDLE_STANDARD_ARGS(HDF5 DEFAULT_MSG HDF5_C++_LIBRARY HDF5_INCLUDE_DIR)
  if (HDF5_FOUND)
      SET(HDF5_LIBRARIES optimized ${HDF5_LIBRARY} optimized ${HDF5_C++_LIBRARY})
      SET(HDF5_C++_LIBRARIES optimized ${HDF_C++_LIBRARY})
  endif()

  MARK_AS_ADVANCED(HDF5_C++_LIBRARY HDF5_LIBRARY HDF5_INCLUDE_DIR)
  
ELSE(MSVC)
    FIND_PACKAGE_HANDLE_STANDARD_ARGS(HDF5 DEFAULT_MSG HDF5_LIBRARY HDF5_C++_LIBRARY HDF5_INCLUDE_DIR)
    if (HDF5_FOUND)
