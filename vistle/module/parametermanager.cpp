...
bool ParameterManager::updateParameter(const std::string &name, const Parameter *param, const message::SetParameter *inResponseTo, Parameter::RangeType rt) {
...
template<class T>
Parameter *ParameterManager::addParameter(const std::string &name, const std::string &description, const T &value, Parameter::Presentation pres) {
...
bool ParameterManager::setStringParameter(const std::string & name,
...
bool ParameterManager::setFloatParameter(const std::string & name,
...
bool ParameterManager::setVectorParameter(const std::string & name,
...
bool ParameterManager::setIntVectorParameter(const std::string & name,
