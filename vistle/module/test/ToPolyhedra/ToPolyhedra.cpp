...
ToPolyhedra::ToPolyhedra(const std::string &name, int moduleID, mpi::communicator comm)
   ...
   p_facestream = addIntParameter("facestream", "create facestream (VTK) or repeat initial vertex of polygon faces (COVISE)", UnstructuredGrid::POLYHEDRON==UnstructuredGrid::VPOLYHEDRON, Parameter::Boolean);
}
