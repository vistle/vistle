...
struct AcousticSourcesBase {
    ...
    static void setReferenceState(double iRho0, double iP0, double iC, Vector const &iFreestream,
...
inline void AcousticSourcesBase::setReferenceState(double iRho0, double iP0, double iC, Vector const &iFreestream,
                                                   Vector const &iFlightspeed)
{
    mRho0 = iRho0;
    mP0 = iP0;
...
inline void AcousticSourcesBase::interpolate(AcousticSourcesBase const &iFrom, AcousticSourcesBase const &iTo,
                                             double iAt)
{
...
inline void AcousticVelocitySources::interpolate(AcousticVelocitySources const &iFrom,
                                                 AcousticVelocitySources const &iTo, double iAt)
{
...
inline void AcousticLineSources::interpolate(AcousticLineSources const &iFrom, AcousticLineSources const &iTo,
                                             double iAt)
{
    AcousticSourcesBase::interpolate(iFrom, iTo, iAt);
...
inline void AcousticSurfaceSources::interpolate(AcousticSurfaceSources const &iFrom, AcousticSurfaceSources const &iTo,
                                                double iAt)
{
    AcousticSourcesBase::interpolate(iFrom, iTo, iAt);
...
inline void AcousticVolumeSources::interpolate(AcousticVolumeSources const &iFrom, AcousticVolumeSources const &iTo,
                                               double iAt)
{
    AcousticSourcesBase::interpolate(iFrom, iTo, iAt);
...
{
    return std::isinf(x.mVi.X()) || std::isinf(x.mV.X()) || std::isinf(x.mVd.X()) || std::isinf(x.mQdd) ||
           std::isinf(x.mQd) || std::isinf(x.mQ) || std::isinf(x.mDd) || std::isinf(x.mD) || std::isinf(x.mMd) ||
           std::isinf(x.mM);
}
