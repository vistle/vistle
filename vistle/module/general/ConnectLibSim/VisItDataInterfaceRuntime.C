...
simv2_invoke_GetMetaData(void)
{
    ...
    if(callbacks != nullptr && callbacks->cb_GetMetaData != nullptr)
    {
        ...
        if(h != VISIT_INVALID_HANDLE)
        {
            ...
            {
                simv2_FreeObject(h);
                std::cerr << "The simulation returned a handle for an object other than simulation metadata." << std::endl;
            }
...
simv2_invoke_GetMaterial(int dom, const char *name)
{
    ...
    if(callbacks != nullptr && callbacks->cb_GetMaterial != nullptr)
    {
        ...
        if(h != VISIT_INVALID_HANDLE)
        {
            ...
            {
                simv2_FreeObject(h);
                std::cerr << "The simulation returned a handle for an object other than a material data object." << std::endl;
            }
...
simv2_invoke_GetSpecies(int dom, const char *name)
{
    ...
    if(callbacks != nullptr && callbacks->cb_GetSpecies != nullptr)
    {
        ...
        if(h != VISIT_INVALID_HANDLE)
        {
            ...
            {
                simv2_FreeObject(h);
                std::cerr << "The simulation returned a handle for an object other than a species data object." << std::endl;
            }
...
simv2_invoke_GetDomainList(const char *name)
{
    ...
    if(callbacks != nullptr && callbacks->cb_GetDomainList != nullptr)
    {
        ...
        if(h != VISIT_INVALID_HANDLE)
        {
            ...
            {
                simv2_FreeObject(h);
                std::cerr << "The domain list returned by the simulation did not pass a consistency check." << std::endl;
            }
        }
    }
    return h;
