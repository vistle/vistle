...
static uint prismTriTable[64][12] = {

{ X, X, X, X, X, X, X, X, X, X, X, X },//0
{ 0, 6, 2, X, X, X, X, X, X, X, X, X },
{ 0, 1, 7, X, X, X, X, X, X, X, X, X },//2
{ 6, 2, 7, 1, 7, 2, X, X, X, X, X, X },
{ 1, 2, 8, X, X, X, X, X, X, X, X, X },//4
{ 1, 6, 8, 1, 0, 6, X, X, X, X, X, X },
{ 0, 2, 8, 7, 0, 8, X, X, X, X, X, X },//6
{ 8, 7, 6, X, X, X, X, X, X, X, X, X },
{ 3, 5, 6, X, X, X, X, X, X, X, X, X },//8
{ 3, 5, 0, 2, 0, 5, X, X, X, X, X, X },
{ 3, 5, 6, 0, 1, 7, X, X, X, X, X, X },//10
{ 3, 2, 1, 3, 5, 2, 3, 1, 7, X, X, X },
{ 1, 2, 8, 3, 5, 6, X, X, X, X, X, X },//12
{ 5, 8, 3, 8, 1, 0, 3, 8, 0, X, X, X },
{ 5, 6, 3, 8, 0, 2, 7, 0, 8, X, X, X },//14
{ 5, 8, 7, 7, 3, 5, X, X, X, X, X, X },
{ 3, 7, 4, X, X, X, X, X, X, X, X, X },//16
{ 0, 6, 2, 3, 7, 4, X, X, X, X, X, X },
{ 0, 1, 4, 4, 3, 0, X, X, X, X, X, X },//18
{ 3, 6, 2, 3, 2, 4, 4, 2, 1, X, X, X },
{ 3, 7, 4, 1, 2, 8, X, X, X, X, X, X },//20
{ 1, 6, 8, 0, 6, 1, 4, 3, 7, X, X, X },
{ 0, 4, 3, 4, 2, 8, 2, 4, 0, X, X, X },//22
{ 3, 6, 8, 8, 4, 3, X, X, X, X, X, X },
{ 5, 6, 7, 7, 4, 5, X, X, X, X, X, X },//24
{ 5, 2, 4, 4, 2, 7, 2, 0, 7, X, X, X },
{ 6, 0, 5, 0, 1, 5, 1, 4, 5, X, X, X },//26
{ 5, 1, 4, 2, 1, 5, X, X, X, X, X, X },
{ 5, 7, 4, 7, 5, 6, 2, 8, 1, X, X, X },//28
{ 1, 0, 8, 8, 0, 5, 7, 5, 4, 5, 0, 7 },
{ 0, 2, 8, 0, 8, 4, 4, 6, 0, 6, 4, 5 },//30
{ 4, 5, 8, X, X, X, X, X, X, X, X, X },
{ 4, 8, 5, X, X, X, X, X, X, X, X, X },//32
{ 0, 6, 2, 4, 8, 5, X, X, X, X, X, X },
{ 4, 8, 5, 0, 1, 7, X, X, X, X, X, X },//34
{ 6, 2, 1, 1, 7, 6, 4, 8, 5, X, X, X },
{ 5, 4, 1, 1, 2, 5, X, X, X, X, X, X },//36
{ 6, 5, 0, 0, 5, 1, 1, 5, 4, X, X, X },
{ 5, 4, 2, 4, 7, 2, 2, 7, 0, X, X, X },//38
{ 5, 7, 6, 7, 5, 4, X, X, X, X, X, X },
{ 6, 3, 8, 8, 3, 4, X, X, X, X, X, X },//40
{ 0, 3, 4, 4, 8, 2, 2, 0, 4, X, X, X },
{ 8, 6, 3, 3, 4, 8, 0, 1, 7, X, X, X },//42
{ 2, 1, 7, 2, 7, 3, 3, 8, 2, 3, 4, 8 },
{ 6, 3, 2, 3, 4, 2, 4, 1, 2, X, X, X },//44
{ 3, 4, 1, 1, 0, 3, X, X, X, X, X, X },
{ 3, 4, 6, 4, 2, 6, 4, 7, 2, 7, 0, 2 },//46
{ 3, 4, 7, X, X, X, X, X, X, X, X, X },
{ 5, 7, 8, 7, 5, 3, X, X, X, X, X, X },//48
{ 0, 6, 2, 5, 3, 8, 3, 7, 8, X, X, X },
{ 5, 3, 8, 8, 0, 1, 3, 0, 8, X, X, X },//50
{ 5, 3, 8, 3, 6, 1, 3, 1, 8, 2, 1, 6 },
{ 1, 2, 3, 5, 3, 2, 1, 3, 7, X, X, X },//52
{ 5, 3, 7, 5, 7, 1, 5, 1, 6, 1, 0, 6 },
{ 0, 5, 3, 2, 5, 0, X, X, X, X, X, X },//54
{ 6, 5, 3, X, X, X, X, X, X, X, X, X },
{ 6, 7, 8, X, X, X, X, X, X, X, X, X },//56
{ 8, 2, 0, 8, 0, 7, X, X, X, X, X, X },
{ 1, 8, 6, 0, 1, 6, X, X, X, X, X, X },//58
{ 1, 8, 2, X, X, X, X, X, X, X, X, X },
{ 6, 7, 2, 1, 2, 7, X, X, X, X, X, X },//60
...
static uint prismNumVertsTable[64] = {
...
static uint pyrTriTable[32][12] = {
    ...
    { 1, 2, 3, 3, 2, 4, X, X, X, X, X, X },
    { 4, 5, 6, X, X, X, X, X, X, X, X, X },
    { 0, 1, 2, 4, 5, 6, X, X, X, X, X, X },
    { 0, 5, 3, 5, 6, 3, X, X, X, X, X, X },//6
    { 1, 6, 3, 1, 2, 5, 6, 1, 5, X, X, X },
    { 2, 7, 5, X, X, X, X, X, X, X, X, X },//8
    { 0, 1, 7, 5, 0, 7, X, X, X, X, X, X },
    { 0, 4, 3, 2, 7, 5, X, X, X, X, X, X },//10
    { 3, 1, 7, 4, 3, 7, 7, 5, 4, X, X, X },
    { 4, 7, 6, 7, 4, 2, X, X, X, X, X, X },//12
    { 1, 7, 6, 0, 1, 6, 0, 6, 4, X, X, X },
    { 3, 7, 6, 0, 7, 3, 2, 7, 0, X, X, X },//14
    { 1, 7, 3, 6, 3, 7, X, X, X, X, X, X },
    { 1, 3, 7, 6, 7, 3, X, X, X, X, X, X },//16
    { 2, 0, 7, 0, 3, 7, 3, 6, 7, X, X, X },
    { 0, 6, 1, 4, 6, 0, 1, 6, 7, X, X, X },//18
    { 2, 4, 7, 4, 6, 7, X, X, X, X, X, X },
    { 3, 7, 1, 4, 7, 3, 7, 4, 5, X, X, X },//20
    { 2, 0, 3, 3, 7, 2, 4, 7, 3, 7, 4, 5 },
    { 0, 7, 1, 5, 7, 0, X, X, X, X, X, X },//22
    { 2, 5, 7, X, X, X, X, X, X, X, X, X },
    { 1, 3, 6, 2, 1, 6, 5, 2, 6, X, X, X },//24
    { 0, 3, 5, 5, 3, 6, X, X, X, X, X, X },
    { 2, 1, 5, 5, 1, 6, 0, 4, 6, 0, 6, 1 },//26
    { 4, 6, 5, X, X, X, X, X, X, X, X, X },
    { 2, 1, 3, 2, 3, 4, X, X, X, X, X, X },//28
    { 0, 3, 4, X, X, X, X, X, X, X, X, X },
