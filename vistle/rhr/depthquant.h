...
__device__ __host__
#endif
inline void setdepth(DepthQuantize &q, int idx, uint32_t value) {
...
__device__ __host__
#endif
inline void dq_setbit(DepthQuantize &q, int bit, unsigned value=1) {
...
__device__ __host__
#endif
inline unsigned dq_getbit(const DepthQuantize &q, int bit) {
...
__device__ __host__
#endif
inline void dq_setbits(DepthQuantize &q, int bit, int nbits, unsigned value, int block=1) {
#if 0
...
__device__ __host__
#endif
inline void dq_setbits(DepthQuantize &q, uint64_t bits) {
...
__device__ __host__
#endif
inline unsigned dq_getbits(const DepthQuantize &q, int bit, int nbits) {
   unsigned v = 0;
...
__device__ __host__
#endif
inline uint64_t dq_getbits(const DepthQuantize &q) {
...
__device__ __host__
#endif
inline uint32_t get_depth(const unsigned char *img, int x, int y, int w, int h);

template<>
#ifdef __CUDACC__
__device__ __host__
#endif
inline uint32_t get_depth<DepthFloat, 4>(const unsigned char *img, int x, int y, int w, int h) {
...
__device__ __host__
#endif
inline uint32_t get_depth<DepthRGBA, 4>(const unsigned char *img, int x, int y, int w, int h) {
...
__device__ __host__
#endif
inline uint32_t get_depth<DepthInteger, 1>(const unsigned char *img, int x, int y, int w, int h) {
...
__device__ __host__
#endif
inline uint32_t get_depth<DepthInteger, 2>(const unsigned char *img, int x, int y, int w, int h) {
...
__device__ __host__
#endif
inline uint32_t get_depth<DepthInteger, 3>(const unsigned char *img, int x, int y, int w, int h) {
...
__device__ __host__
#endif
inline uint32_t get_depth<DepthInteger, 4>(const unsigned char *img, int x, int y, int w, int h) {
