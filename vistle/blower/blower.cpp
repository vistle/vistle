...
class StatePrinter: public StateObserver {
 ...
 public:
   ...
   void info(const std::string &text, message::SendText::TextType textType, int senderId, int senderRank, message::Message::Type refType, const message::Message::uuid_t &refUuid) {
