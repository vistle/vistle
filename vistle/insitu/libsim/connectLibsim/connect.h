...
bool V_LIBSIMCONNECTEXPORT sendInitToSim(const std::vector<std::string> launchArgs,
                                         const std::string &host, int port, const std::string &key);
bool V_LIBSIMCONNECTEXPORT attemptLibSImConnection(const std::string &path,
