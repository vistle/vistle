...
void VisIt_PointMesh::FreeCoordinates()
{
...
static VisIt_PointMesh *GetObject(visit_handle h, const char *fname)
{
    char tmp[100];
...
static int simv2_PointMesh_setCoords_helper(visit_handle h, visit_handle *cHandles, int ndims, const char *fname)
{
    int retval = VISIT_ERROR;
...
int simv2_PointMesh_setCoordsXY(visit_handle h, visit_handle x, visit_handle y)
{
    visit_handle cHandles[2];
    cHandles[0] = x;
    cHandles[1] = y;
    return simv2_PointMesh_setCoords_helper(h, cHandles, 2, "simv2_PointMesh_setCoordsXY");
}

int simv2_PointMesh_setCoordsXYZ(visit_handle h, visit_handle x, visit_handle y, visit_handle z)
{
    visit_handle cHandles[3];
    cHandles[0] = x;
    cHandles[1] = y;
    cHandles[2] = z;
    return simv2_PointMesh_setCoords_helper(h, cHandles, 3, "simv2_PointMesh_setCoordsXYZ");
}

int simv2_PointMesh_setCoords(visit_handle h, visit_handle coords)
{
    int retval = VISIT_ERROR;
...
int simv2_PointMesh_getCoords(visit_handle h, int *ndims, int *coordMode, visit_handle *x, visit_handle *y,
...
int simv2_PointMesh_check(visit_handle h)
{
    int retval = VISIT_ERROR;
