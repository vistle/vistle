...
V_LIBSIMXPORT visit_handle simv2_invoke_GetSpecies(int, const char *);
V_LIBSIMXPORT visit_handle simv2_invoke_GetVariable(int, const char *);
V_LIBSIMXPORT visit_handle simv2_invoke_GetMixedVariable(int, const char *);
V_LIBSIMXPORT visit_handle simv2_invoke_GetCurve(const char *);
V_LIBSIMXPORT visit_handle simv2_invoke_GetDomainList(const char *);
V_LIBSIMXPORT visit_handle simv2_invoke_GetDomainBoundaries(const char *name);
V_LIBSIMXPORT visit_handle simv2_invoke_GetDomainNesting(const char *name);

V_LIBSIMXPORT int simv2_invoke_WriteBegin(const char *);
V_LIBSIMXPORT int simv2_invoke_WriteEnd(const char *);
