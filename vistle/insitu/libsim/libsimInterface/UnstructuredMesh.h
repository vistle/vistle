...
V_LIBSIMXPORT int simv2_UnstructuredMesh_setConnectivity(visit_handle obj, int nzones,
                                                     visit_handle conn);
...
V_LIBSIMXPORT int simv2_UnstructuredMesh_getCoords(visit_handle h,
                                               int *ndims, int *coordMode,
                                               visit_handle *x, 
                                               visit_handle *y, 
                                               visit_handle *z, 
                                               visit_handle *coords);
V_LIBSIMXPORT int simv2_UnstructuredMesh_getConnectivity(visit_handle h, int *nzones,
                                                     visit_handle *conn);
