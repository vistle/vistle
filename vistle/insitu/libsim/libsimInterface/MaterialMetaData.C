...
static VisIt_MaterialMetaData *GetObject(visit_handle h, const char *fname)
{
    char tmp[100];
...
int simv2_MaterialMetaData_setName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MaterialMetaData_getName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MaterialMetaData_setMeshName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MaterialMetaData_getMeshName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_MaterialMetaData_addMaterialName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_MaterialMetaData_getNumMaterialNames(visit_handle h, int *val)
{
    if (val == NULL) {
...
int simv2_MaterialMetaData_getMaterialName(visit_handle h, int i, char **val)
{
    if (val == NULL) {
...
int simv2_MaterialMetaData_check(visit_handle h)
{
