...
public:
    ...
    void InitializeViewer(const std::vector<std::string> &plotPlugins, const std::vector<std::string> &operatorPlugins,
                          bool noconfig);
    ...
    // Viewer-ey methods.
    bool ExportDatabase(const std::string &filename, const std::string &format, const stringVector &vars,
    ...
    bool SetPlotOptions(const std::string &fieldName, int fieldType, void *fieldVal, int fieldLen);
    bool SetOperatorOptions(const std::string &fieldName, int fieldType, void *fieldVal, int fieldLen);
...
private:
    ...
    void RestrictPlugins(PluginManager *mgr, const std::vector<std::string> &idsOrNames);
