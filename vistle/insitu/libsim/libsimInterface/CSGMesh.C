...
void VisIt_CSGMesh::FreeRegions()
{
...
void VisIt_CSGMesh::FreeZonelist()
{
...
void VisIt_CSGMesh::FreeBoundaryTypes()
{
...
void VisIt_CSGMesh::FreeBoundaryCoeffs()
{
...
static VisIt_CSGMesh *GetObject(visit_handle h)
{
...
int simv2_CSGMesh_setRegions(visit_handle h, visit_handle typeflags, visit_handle leftids, visit_handle rightids)
{
    int retval = VISIT_ERROR;
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        if (simv2_VariableData_getArrayData(cHandles[i], 0, memory[i], owner[i], dataType[i], nComps[i], nTuples[i],
                                            offset[i], stride[i], data[i]) == VISIT_ERROR) {
            return VISIT_ERROR;
        }
...
int simv2_CSGMesh_setZonelist(visit_handle h, visit_handle zonelist)
{
    int retval = VISIT_ERROR;
    VisIt_CSGMesh *obj = GetObject(h);
    if (obj != NULL) {
        ...
        void *data = NULL;
        if (simv2_VariableData_getArrayData(zonelist, 0, memory, owner, dataType, nComps, nTuples, offset, stride,
                                            data) == VISIT_ERROR) {
            return VISIT_ERROR;
        }
        // Error checking.
...
int simv2_CSGMesh_setBoundaryTypes(visit_handle h, visit_handle boundaryTypes)
{
    int retval = VISIT_ERROR;
    VisIt_CSGMesh *obj = GetObject(h);
    if (obj != NULL) {
        ...
        int memory, owner, dataType, nComps, nTuples, offset, stride;
        void *data = NULL;
        if (simv2_VariableData_getArrayData(boundaryTypes, 0, memory, owner, dataType, nComps, nTuples, offset, stride,
                                            data) == VISIT_ERROR) {
            return VISIT_ERROR;
        }
        // Error checking.
...
int simv2_CSGMesh_setBoundaryCoeffs(visit_handle h, visit_handle boundaryCoeffs)
{
    int retval = VISIT_ERROR;
    VisIt_CSGMesh *obj = GetObject(h);
    if (obj != NULL) {
        ...
        int memory, owner, dataType, nComps, nTuples, offset, stride;
        void *data = NULL;
        if (simv2_VariableData_getArrayData(boundaryCoeffs, 0, memory, owner, dataType, nComps, nTuples, offset, stride,
                                            data) == VISIT_ERROR) {
            return VISIT_ERROR;
        }
        // Error checking.
        ...
        if (dataType != VISIT_DATATYPE_DOUBLE && dataType != VISIT_DATATYPE_FLOAT) {
...
int simv2_CSGMesh_setExtents(visit_handle h, double min[3], double max[3])
{
    int retval = VISIT_ERROR;
    VisIt_CSGMesh *obj = GetObject(h);
    if (obj != NULL) {
...
int simv2_CSGMesh_getRegions(visit_handle h, visit_handle *typeflags, visit_handle *left, visit_handle *right)
{
    int retval = VISIT_ERROR;
    VisIt_CSGMesh *obj = GetObject(h);
    if (obj != NULL) {
...
int simv2_CSGMesh_getZonelist(visit_handle h, visit_handle *zl)
{
    int retval = VISIT_ERROR;
    VisIt_CSGMesh *obj = GetObject(h);
    if (obj != NULL) {
...
int simv2_CSGMesh_getBoundaryTypes(visit_handle h, visit_handle *bndtypes)
{
    int retval = VISIT_ERROR;
    VisIt_CSGMesh *obj = GetObject(h);
    if (obj != NULL) {
...
int simv2_CSGMesh_getBoundaryCoeffs(visit_handle h, visit_handle *bndcoeff)
{
    int retval = VISIT_ERROR;
    VisIt_CSGMesh *obj = GetObject(h);
    if (obj != NULL) {
...
int simv2_CSGMesh_getExtents(visit_handle h, double min[3], double max[3])
{
    int retval = VISIT_ERROR;
    VisIt_CSGMesh *obj = GetObject(h);
    if (obj != NULL) {
...
int simv2_CSGMesh_check(visit_handle h)
{
    VisIt_CSGMesh *obj = GetObject(h);
    int retval = VISIT_ERROR;
    if (obj != NULL) {
