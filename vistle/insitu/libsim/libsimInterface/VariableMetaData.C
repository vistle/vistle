...
static VisIt_VariableMetaData *GetObject(visit_handle h, const char *fname)
{
    char tmp[150];
    ...
    if (obj != NULL) {
        if (obj->objectType() != VISIT_VARIABLEMETADATA) {
            snprintf(tmp, 150,
                     ...
                     "a VariableMetaData object. (type=%d)",
                     fname, obj->type);
            VisItError(tmp);
            obj = NULL;
        }
...
int simv2_VariableMetaData_setName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_getName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_setMeshName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_getMeshName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_setUnits(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_getUnits(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_setCentering(visit_handle h, int val)
{
    if (val != VISIT_VARCENTERING_NODE && val != VISIT_VARCENTERING_ZONE) {
...
int simv2_VariableMetaData_getCentering(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_VariableMetaData_setType(visit_handle h, int val)
{
...
int simv2_VariableMetaData_getType(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_VariableMetaData_setTreatAsASCII(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_VariableMetaData_getTreatAsASCII(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_VariableMetaData_setHideFromGUI(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_VariableMetaData_getHideFromGUI(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_VariableMetaData_setNumComponents(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_VariableMetaData_getNumComponents(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_VariableMetaData_addMaterialName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_getNumMaterialNames(visit_handle h, int *val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_getMaterialName(visit_handle h, int i, char **val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_setEnumerationType(visit_handle h, int val)
{
    int retval = VISIT_ERROR;
...
int simv2_VariableMetaData_getEnumerationType(visit_handle h, int *val)
{
    int retval = VISIT_ERROR;
    if (val == NULL) {
...
int simv2_VariableMetaData_addEnumNameRange(visit_handle h, const char *name, double minVal, double maxVal, int *index)
{
    int retval = VISIT_ERROR;
    VisIt_VariableMetaData *obj = GetObject(h, "simv2_VariableMetaData_setEnumerationType");
    if (obj != NULL) {
...
int simv2_VariableMetaData_getNumEnumNames(visit_handle h, int *val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_getEnumName(visit_handle h, int i, char **val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_getNumEnumNameRanges(visit_handle h, int *val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_getEnumNameRange(visit_handle h, int i, double *minVal, double *maxVal)
{
...
int simv2_VariableMetaData_addEnumGraphEdge(visit_handle h, int head, int tail, const char *edgeName)
{
    int retval = VISIT_ERROR;
...
int simv2_VariableMetaData_getNumEnumGraphEdges(visit_handle h, int *val)
{
    if (val == NULL) {
...
int simv2_VariableMetaData_getEnumGraphEdge(visit_handle h, int i, int *head, int *tail, char **edgeName)
{
...
int simv2_VariableMetaData_setEnumAlwaysIncludeValue(visit_handle h, double val)
{
    int retval = VISIT_ERROR;
...
int simv2_VariableMetaData_setEnumAlwaysIncludeRange(visit_handle h, double minVal, double maxVal)
{
    int retval = VISIT_ERROR;
...
int simv2_VariableMetaData_getEnumAlwaysIncludeRange(visit_handle h, double *minVal, double *maxVal)
{
    if (minVal == NULL || maxVal == NULL) {
...
int simv2_VariableMetaData_setEnumAlwaysExcludeValue(visit_handle h, double val)
{
    int retval = VISIT_ERROR;
...
int simv2_VariableMetaData_setEnumAlwaysExcludeRange(visit_handle h, double minVal, double maxVal)
{
    int retval = VISIT_ERROR;
...
int simv2_VariableMetaData_getEnumAlwaysExcludeRange(visit_handle h, double *minVal, double *maxVal)
{
    if (minVal == NULL || maxVal == NULL) {
...
int simv2_VariableMetaData_check(visit_handle h)
{
