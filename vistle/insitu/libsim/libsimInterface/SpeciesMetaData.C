...
static VisIt_SpeciesMetaData *GetObject(visit_handle h, const char *fname)
{
    char tmp[100];
...
int simv2_SpeciesMetaData_setName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_SpeciesMetaData_getName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_SpeciesMetaData_setMeshName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_SpeciesMetaData_getMeshName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_SpeciesMetaData_setMaterialName(visit_handle h, const char *val)
{
    if (val == NULL) {
...
int simv2_SpeciesMetaData_getMaterialName(visit_handle h, char **val)
{
    if (val == NULL) {
...
int simv2_SpeciesMetaData_addSpeciesName(visit_handle h, visit_handle val)
{
...
int simv2_SpeciesMetaData_getNumSpeciesName(visit_handle h, int *val)
{
    if (val == NULL) {
...
int simv2_SpeciesMetaData_getSpeciesName(visit_handle h, int i, visit_handle *val)
{
    if (val == NULL) {
...
int simv2_SpeciesMetaData_check(visit_handle h)
{
