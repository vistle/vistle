...
bool SyncShmIDs::isInitialized() { return m_initialized; }
...
SyncShmIDs::ShmSegment::~ShmSegment() { boost::interprocess::shared_memory_object::remove(m_name.c_str()); }

const SyncShmIDs::ShmData *SyncShmIDs::ShmSegment::data() const {
    return static_cast<ShmData *>(m_region.get_address());
}
SyncShmIDs::ShmData *SyncShmIDs::ShmSegment::data() { return static_cast<ShmData *>(m_region.get_address()); }
