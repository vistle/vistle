...
void SyncShmIDs::initialize(int moduleID, int rank, const std::string &suffix, Mode mode)
{
    ...
    m_rank = rank;
    std::string segName =
    vistle::message::MessageQueue::createName(("syncShmIds" + suffix).c_str(), moduleID, rank);
...
SyncShmIDs::ShmSegment &
SyncShmIDs::ShmSegment::operator=(insitu::message::SyncShmIDs::ShmSegment &&other) noexcept
{
