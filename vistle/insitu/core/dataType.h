...
template <typename T> constexpr DataType getDataType() { return DataType::INVALID; }
...
template <> constexpr DataType getDataType<vistle::Index>() { return DataType::INDEX; }
template <> constexpr DataType getDataType<vistle::Byte>() { return DataType::BYTE; }
} // namespace insitu
} // namespace vistle
#endif