...
DataBase::ptr V_VTK_EXPORT getField(SENSEI_ARGUMENT vtkDataSetAttributes* ds, const std::string& name, Object::const_ptr grid = Object::const_ptr());
DataBase::ptr V_VTK_EXPORT getField(SENSEI_ARGUMENT vtkFieldData *ds, const std::string &name, Object::const_ptr grid=Object::const_ptr());
#ifdef SENSEI
