...
public:
	...
	*/
    ...
    inline const Coordinate operator-() const { return Coordinate(-pos[0], -pos[1], -pos[2]); }

    /** Length of the vector = sqrt( vec . vec ) */
    inline float length() const { return sqrtf(pos[0] * pos[0] + pos[1] * pos[1] + pos[2] * pos[2]); }

    /** Multiply by scalar. */
    inline const Coordinate operator*(float rhs) const { return Coordinate(pos[0] * rhs, pos[1] * rhs, pos[2] * rhs); }
    ...
    inline const Coordinate operator^(const Coordinate &rhs) const
    {
        return Coordinate(pos[1] * rhs.pos[2] - pos[2] * rhs.pos[1], pos[2] * rhs.pos[0] - pos[0] * rhs.pos[2],
