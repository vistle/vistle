...
template<unsigned Dim>
Object::ptr ToGrid::calculateGrid(Points::const_ptr points, typename Vec<Scalar, Dim>::const_ptr data)
{
...
ToGrid::ToGrid(const std::string &name, int moduleID, mpi::communicator comm): Module(name, moduleID, comm)
{
