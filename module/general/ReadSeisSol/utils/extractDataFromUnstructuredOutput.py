'''
Source: https://github.com/SeisSol/SeisSol

Changes: Marko Djuric
'''
...
parser.add_argument("--version", type=int, help="xdmf version", default=2, choices=[2, 3])
...
prefix_new = rxdmf.generate_new_prefix(prefix, args.add2prefix)
...
ncells = rxdmf.ReadNcellsFromXdmf(args.xdmfFilename)
dt = rxdmf.ReadDtFromXdmf(args.xdmfFilename)
nvertex = rxdmf.ReadNvertexFromXdmf(args.xdmfFilename)
ndt, nmem = rxdmf.ReadNdtNmemFromXdmf(args.xdmfFilename)
rxdmf.recreateXdmf(prefix, prefix_new, nvertex, ncells, ncells, dt, indices, args.Data, not write2Binary, myprec, args.add2prefix, version=args.version, ndt=ndt)
