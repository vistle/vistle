...
void CuttingSurfaceVtkm::runFilter(vtkm::cont::DataSet &inputData, vtkm::cont::DataSet &outputData) const
{
    ...
    sliceFilter.SetActiveField(m_mapSpecies);

    outputData = sliceFilter.Execute(inputData);
}
