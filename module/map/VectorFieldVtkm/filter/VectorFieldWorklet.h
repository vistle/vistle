#ifndef VISTLE_VECTORFIELDVTKM_VECTORFIELDWORKLET_H
...
struct VectorFieldWorklet : public viskores::worklet::WorkletMapField
{
    ...
    VISKORES_CONT
    VectorFieldWorklet(viskores::FloatDefault minLen,
                       viskores::FloatDefault maxLen,
    ...
    VISKORES_EXEC void operator()(const VecType& vec,
                                  const VecType& base,
                                  VecType& outP0,
                                  VecType& outP1) const
    {
...
#endif // VISTLE_VECTORFIELDVTKM_VECTORFIELDWORKLET_H
