...
envvars="PATH VISTLE_KEY VISTLE_SHM_SIZE VISTLE_SHM_PER_RANK LD_LIBRARY_PATH DYLD_LIBRRARY_PATH VISTLE_DYLD_LIBRARY_PATH COVISE_PATH COVISEDIR ARCHSUFFIX COCONFIG COCONFIG_DEBUG PYTHONHOME PYTHONPATH"
